<nav class="title-bar" style="background-color: #c0c0c0; padding: 10px; border-bottom: 2px solid #000000; display: flex; justify-content: center;">
    <ul class="window-body" style="list-style-type: none; margin: 0; padding: 0; display: flex;">
        <li style="margin: 0 10px;"><a href="/College%20campus/index.php" style="color: white; text-decoration: none; padding: 5px 10px; border: 2px solid #000000; background-color: #004080;">Home</a></li>
        <li style="margin: 0 10px;"><a href="/College%20campus/pages/user/basic_info.php" style="color: white; text-decoration: none; padding: 5px 10px; border: 2px solid #000000; background-color: #004080;">User</a></li>
        <li style="margin: 0 10px;"><a href="/College%20campus/pages/activity_flow/index.php" style="color: white; text-decoration: none; padding: 5px 10px; border: 2px solid #000000; background-color: #004080;">Activity Flow</a></li>
        <li style="margin: 0 10px;"><a href="/College%20campus/pages/courses/index.php" style="color: white; text-decoration: none; padding: 5px 10px; border: 2px solid #000000; background-color: #004080;">Courses</a></li>
